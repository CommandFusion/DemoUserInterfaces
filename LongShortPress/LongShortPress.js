...
1. On press with delay for the long press
2. On release for the short press (cancelled if the long press is activated)
...
with 2 button actions.
Action 1: On press, 1000ms hold delay, call script LongShortPress.onLongPress("Lights Off");
Action 2: On release, no delays, call script LongShortPress.onShortRelease("Lights Dim Down");
